package common.cdk.cryption.rsa;
...
/** * 产生公钥和私钥对，并且保存在文件中，公钥 pk.dat，私钥 sk.dat * * @author Administrator * */
public class KeyGen {
	...
	/**
	 * * 根据keyInfo产生公钥和私钥，并且保存到pk.dat和sk.dat文件中 * * @param keyInfo * @throws
	 * Exception
	 */
	public void genKeys(String keyInfo) throws Exception {
		...
		keygen.initialize(512, random); // 取得密钥对
		KeyPair kp = keygen.generateKeyPair(); // 取得公钥
		PublicKey publicKey = kp.getPublic();
		System.out.println(publicKey);
		saveFile(publicKey, "pk.dat"); // 取得私钥
